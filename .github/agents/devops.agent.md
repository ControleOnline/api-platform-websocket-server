---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-websocket-server, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-websocket-server`.
...
- Checkout local: `api-community/modules/controleonline/websocket-server`
